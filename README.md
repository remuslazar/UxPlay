...
An audio track selected on the client (e.g., in the YouTube app) takes precedence over these preferences;
selecting another one during the video restarts it at the same position with that track.
